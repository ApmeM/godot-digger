...
public class FloorDefinition
{
    public static Dictionary<Floor, FloorDefinition> KnownFloors = new Dictionary<Floor, FloorDefinition>{
        ...
        { Floor.StairsUp, new FloorDefinition{ClickAction = (level, pos)=>{level.ExitDungeonClicked(Floor.StairsUp);}} },
        { Floor.StairsDown, new FloorDefinition{ClickAction = (level, pos)=>{level.ExitDungeonClicked(Floor.StairsDown);}} },
